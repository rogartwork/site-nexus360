...
export default function PortalClienteLoginPage() {
  ...
  return (
    <main className="min-h-screen bg-[#1e2128] text-[#eaeff5] flex items-center justify-center p-6 relative overflow-hidden selection:bg-[#a855f7]/30 font-sans">
      ...
      <div className="absolute inset-0 pointer-events-none z-0">
        <div className="absolute top-[20%] left-[20%] w-[35%] h-[35%] bg-[#a855f7]/3 blur-[120px] rounded-full" />
        <div className="absolute bottom-[20%] right-[20%] w-[35%] h-[35%] bg-[#a855f7]/2 blur-[120px] rounded-full" />
      </div>
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-[#a855f7] text-[9px] font-mono font-bold tracking-[0.4em] uppercase mt-6">PORTAL DO CLIENTE</p>
        </div>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            <div className="space-y-2">
              ...
              <div className="relative group">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-[#94a3b8] group-focus-within:text-[#a855f7] transition-colors">
                  <LucideUser size={18} />
                </div>
                <input
                  type="text"
                  ...
                  className="w-full nm-inset py-4 pl-12 pr-4 text-sm font-medium outline-none text-[#eaeff5] placeholder:text-[#94a3b8]/30 transition-all focus:border-[#a855f7]/30"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full nm-button text-[#eaeff5] hover:text-[#a855f7] font-mono font-black uppercase tracking-[0.2em] text-xs py-5 transition-all flex items-center justify-center gap-3 disabled:opacity-50"
            >
              {loading ? (
                <>
                  <LucideLoader2 size={18} className="animate-spin text-[#a855f7]" />
                  Acessando...
                </>
              ) : (
                <>
                  <LucideShieldCheck size={18} className="text-[#a855f7]" />
                  Entrar no Portal
                </>
              )}
            </button>
        ...
        <div className="mt-8 flex items-center justify-between px-2 opacity-40 font-mono text-[8px] uppercase tracking-widest text-[#94a3b8]">
          <div className="flex items-center gap-2">
            <div className="w-1.5 h-1.5 bg-[#a855f7] rounded-full animate-pulse-subtle" />
