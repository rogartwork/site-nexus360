...
export default function ClientPanel() {
  ...
  const StatusBadge = ({ status }: { status: string }) => {
    const map: Record<string, { label: string; cls: string }> = {
      OPEN: { label: "Aguardando Suporte", cls: "bg-[#a855f7]/10 text-[#a855f7] border-[#a855f7]/20" },
  ...
  if (loading) return (
    <div className="min-h-screen bg-[#1e2128] flex items-center justify-center text-[#a855f7]">
      <LucideMonitor size={36} className="animate-bounce" />
    </div>
  );

  return (
    <div className="min-h-screen bg-[#1e2128] text-[#eaeff5] font-sans selection:bg-[#a855f7]/30">
      ...
      <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
        <div className="absolute top-[5%] right-[5%] w-[45%] h-[45%] bg-[#a855f7]/3 blur-[130px] rounded-full" />
      </div>
            ...
            return (
              <button
                ...
                className={`w-full flex items-center gap-3 px-4 py-3.5 rounded-xl font-mono text-[9px] font-black uppercase tracking-widest transition-all ${isActive
                  ? 'nm-inset text-[#a855f7]'
                  : 'text-[#94a3b8] hover:text-[#eaeff5] nm-button'
                  }`}
              >
                <item.icon size={14} className={isActive ? "text-[#a855f7]" : "text-[#94a3b8]"} />
                {item.label}
              </button>
            );
          })}
        ...
        <header className="sticky top-0 z-40 bg-[#1e2128]/85 backdrop-blur-md border-b border-[#2b303b]/30 px-8 py-5 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4 cursor-pointer group" onClick={openProfileModal}>
            <div className="text-right">
              ...
              <p className="text-[24px] font-mono font-black text-[#eaeff5] group-hover:text-[#a855f7] transition-colors">{customerData.name}</p>
            ...
            <div className="w-10 h-10 nm-flat flex items-center justify-center text-[#a855f7] group-hover:scale-105 transition-transform shrink-0">
              <LucideUser size={16} />
            </div>
          </div>
        </header>
        ...
        <div className="p-8">
          ...
          {activeTab === 'painel' && (
            <div className="space-y-8 animate-in fade-in duration-300">
              ...
              <div className="space-y-6 max-w-4xl">
                            ...
                            <div key={idx} className="space-y-1.5 group/copy">
                                  ...
                                  {editingLicenseId === license.id ? (
                                    <div className="flex items-center gap-1.5 ml-1.5">
                                      <input
                                        ...
                                        className="bg-[#191b20] border border-[#a855f7]/30 rounded-lg px-2 py-0.5 text-[8px] font-mono text-[#eaeff5] w-28 focus:outline-none focus:border-[#a855f7] focus:ring-1 focus:ring-[#a855f7]/20 transition-all font-semibold"
                                        placeholder="Apelido..."
                                        maxLength={20}
                                        autoFocus
                                    ...
                                    <div className="flex items-center gap-1.5 ml-1.5">
                                      {license.label && (
                                        <span className="text-[7.5px] text-[#a855f7] font-mono font-bold uppercase tracking-widest bg-[#a855f7]/5 px-1.5 py-0.5 border border-[#a855f7]/10 rounded-md">
                                          {license.label}
                                        </span>
                                      )}
                                      {license.id && (
                                        <button
                                          ...
                                          className="opacity-40 hover:opacity-100 text-[#94a3b8] hover:text-[#a855f7] transition-all ml-0.5"
                              ...
                              <div className="relative">
                                ...
                                <div className={`absolute inset-0 -m-1 rounded-3xl blur-md transition-all duration-500 pointer-events-none opacity-40 ${isCopied
                                  ...
                                  : "bg-[#a855f7]/5 shadow-[0_0_15px_rgba(56,189,248,0.03)] animate-pulse group-hover/copy:animate-none group-hover/copy:bg-[#a855f7]/10"
                                  }`} />
                                ...
                                <div
                                  ...
                                  className={`relative z-10 flex items-center justify-between gap-4 px-4 py-3 nm-inset rounded-2xl cursor-pointer hover:text-[#a855f7] transition-all duration-300 hover:scale-[1.01] active:scale-[0.99] border overflow-hidden ${isCopied
                                    ? "border-emerald-500/30 bg-gradient-to-r from-[#1e2128] via-emerald-500/8 to-[#1e2128]"
                                    : "border-[#2b303b]/40 hover:border-[#a855f7]/30 bg-gradient-to-r from-[#1e2128] via-[#a855f7]/2 to-[#1e2128]"
                                    }`}
                                  title="Clique para copiar a chave de acesso"
                                >
                                  {/* High-tech Laser Shine Sweep Effect */}
                                  <div className="absolute inset-0 overflow-hidden rounded-2xl pointer-events-none z-0">
                                    <div className="w-16 h-full bg-gradient-to-r from-transparent via-[#a855f7]/15 to-transparent -skew-x-20 absolute -left-20 transition-all duration-1000 ease-out group-hover/copy:translate-x-[600px] pointer-events-none" />
                                  </div>

                                  <span className="relative z-10 text-xs md:text-sm font-mono font-black tracking-widest text-[#eaeff5] group-hover/copy:text-[#a855f7] group-hover/copy:drop-shadow-[0_0_6px_rgba(56,189,248,0.5)] transition-all uppercase select-all">
                                    {isCopied ? "COPIADA COM SUCESSO!" : (license.key || "NX-PENDENTE")}
                                  </span>

                                  <div className="relative z-10 flex items-center gap-1.5 px-2.5 py-1 nm-button rounded-xl text-[8px] font-mono font-black uppercase tracking-widest shrink-0 transition-all text-[#94a3b8] group-hover/copy:text-[#a855f7] group-hover/copy:nm-flat">
                                    {isCopied ? (
                                      <span className="text-emerald-400">COPIADO</span>
                                    ) : (
                                      <>
                                        <LucideCopy size={10} className="text-[#94a3b8]/60 group-hover/copy:text-[#a855f7] transition-colors shrink-0" />
                                        COPIAR
                                      </>
                                    )}
                                  </div>
                ...
                {/* Software Nexus Card */}
                <div className="nm-flat p-6 flex flex-col justify-between border border-[#a855f7]/10 hover:border-[#a855f7]/30 transition-all duration-300 hover:-translate-y-1 group">
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-2">
                      <LucideDownload size={14} className="text-[#a855f7] group-hover:scale-110 transition-transform" />
                      <span className="text-[9px] font-mono font-black uppercase tracking-widest text-[#94a3b8]">Software Nexus</span>
                    </div>
                    <div className="w-1.5 h-1.5 rounded-full bg-[#a855f7]/20 group-hover:bg-[#a855f7] transition-colors" />
                  </div>
                  <div className="space-y-4">
                    <div>
                      <p className="text-[8px] text-[#94a3b8]/60 font-mono uppercase tracking-widest">Build Estável</p>
                      <p className="text-2xl font-black tracking-tight text-[#a855f7]">v3.2.0 Stable</p>
                      <p className="text-[9px] text-[#94a3b8]/60 mt-1 font-mono uppercase tracking-widest">Disponível para Windows 10/11</p>
                    </div>
                  </div>
                  <a
                    href="/nexus360-setup.exe"
                    download
                    className="mt-3 w-full py-4 nm-button text-[#a855f7] hover:text-[#eaeff5] text-[18px] font-mono font-black uppercase tracking-widest flex items-center justify-center gap-2 transition-all rounded-xl"
                  >
                    <LucideDownload size={20} /> Baixar Executável
                  </a>
                </div>
                ...
                <div className="nm-flat p-8 flex gap-6 items-start border border-white/5 transition-all duration-300 hover:-translate-y-1 hover:border-amber-500/20 group">
                  <div className="w-14 h-14 nm-inset flex items-center justify-center text-[#a855f7] shrink-0 rounded-2xl">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex flex-col sm:flex-row items-stretch justify-center gap-6 mt-8 w-full max-w-2xl mx-auto">
                      <button
                        className="px-8 py-4 nm-button text-[9px] font-mono font-black uppercase tracking-widest transition-all text-[#eaeff5]/50 cursor-not-allowed flex flex-col items-center justify-center gap-1 leading-tight flex-1"
                        disabled
                      >
                        <span>RENOVAR VIA PIX</span>
                        <span className="text-[7px] text-[#94a3b8]/40 uppercase tracking-widest">(EM IMPLANTAÇÃO)</span>
                      </button>

                      <a
                        href="https://nexus360.workmanos.com.br/#pricing"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="px-8 py-4 nm-button text-[9px] font-mono font-black uppercase tracking-widest transition-all text-[#eaeff5] hover:text-[#a855f7] flex items-center justify-center flex-1"
                      >
                        RENOVAR VIA SITE
                      </a>
                    </div>
                ...
                <div className="nm-flat p-6 flex flex-col justify-between border border-[#a855f7]/5 hover:border-[#a855f7]/10 transition-all duration-300 group">
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-2">
                      <LucideCalendar size={14} className="text-[#a855f7]" />
                    ...
                    {!customerData?.subscriptions || customerData.subscriptions.length === 0 ? (
                      ...
                      <div className="space-y-2">
                        {customerData.subscriptions.map((sub: any, idx: number) => {
                          ...
                          return (
                            <div key={sub.id || idx} className="flex flex-col md:flex-row md:items-center justify-between gap-3 px-4 py-3 nm-inset rounded-2xl border border-[#2b303b]/20 hover:border-[#a855f7]/10 transition-all duration-300">
                ...
                <div className="h-[calc(100vh-180px)] flex flex-col">
                  ...
                  <div className="flex flex-wrap items-center gap-3 mb-4 shrink-0">
                    <button
                      ...
                      className="flex items-center gap-2 px-4 py-2.5 nm-button text-[#eaeff5] hover:text-[#a855f7] text-[9px] font-mono font-black uppercase tracking-widest transition-all"
                    >
                  ...
                  <div className="flex-1 flex flex-col nm-flat overflow-hidden min-h-0">
                    ...
                    <div className="px-6 py-4 border-b border-[#2b303b]/40 bg-[#1e2128]/40 flex flex-col sm:flex-row sm:items-center justify-between gap-3 shrink-0">
                      <div className="flex items-center gap-3 min-w-0">
                        <LucideMessageSquare size={14} className="text-[#a855f7] shrink-0" />
                        ...
                        (selectedTicket.replies ?? []).map((reply: any) => (
                          <div key={reply.id} className={`flex ${!reply.isAdmin ? "justify-end" : "justify-start"}`}>
                            <div className={`max-w-[70%] rounded-2xl px-5 py-3.5 ${!reply.isAdmin
                              ? "bg-[#a855f7]/5 border border-[#a855f7]/15 rounded-tr-sm"
                              : "bg-[#2b303b]/20 border border-[#2b303b]/30 rounded-tl-sm"
                              }`}>
                              <div className="flex items-center gap-3 mb-2">
                                <span className="text-[8px] font-mono font-black uppercase tracking-widest text-[#a855f7]">
                      ...
                      <div className="px-6 py-4 border-t border-[#2b303b]/40 bg-[#1e2128]/50 shrink-0">
                        <div className="flex items-end gap-4">
                          ...
                          <button
                            ...
                            className="h-10 px-5 nm-button text-[#eaeff5] hover:text-[#a855f7] disabled:opacity-40 rounded-xl text-[9px] font-mono font-black uppercase tracking-widest flex items-center gap-2 transition-all shrink-0"
                          >
                ...
                <div>
                  ...
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 px-5 py-3 nm-button text-[#eaeff5] hover:text-[#a855f7] text-[9px] font-mono font-black uppercase tracking-widest transition-all"
                    >
                  ...
                  <div className="nm-flat overflow-hidden">
                    {tickets.length === 0 ? (
                      <div className="py-20 flex flex-col items-center gap-4 text-[#94a3b8]">
                        <LucideMessageSquare size={36} className="opacity-20 text-[#a855f7]" />
                        <p className="text-[9px] font-mono font-black uppercase tracking-widest">Nenhum chamado aberto ainda</p>
                        <button onClick={() => setShowNewTicketModal(true)} className="text-[9px] text-[#a855f7] hover:underline font-mono font-black uppercase tracking-widest transition-all">
                      ...
                      <div
                        ...
                        className={`flex items-center gap-4 px-6 py-4.5 cursor-pointer hover:bg-[#a855f7]/3 transition-all group ${i < tickets.length - 1 ? 'border-b border-[#2b303b]/30' : ''}`}
                      >
                        <div className={`w-9 h-9 nm-inset flex items-center justify-center shrink-0 ${ticket.status === 'OPEN' ? 'text-[#a855f7]' :
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="text-xs font-bold text-[#eaeff5] truncate group-hover:text-[#a855f7] transition-colors">{ticket.subject}</p>
          ...
          {activeTab === 'licencas' && (
            <div className="nm-flat p-8 max-w-2xl animate-in fade-in duration-300">
              <div className="flex items-center gap-4 mb-8">
                <div className="w-12 h-12 nm-inset flex items-center justify-center text-[#a855f7]">
                  <LucideKey size={20} />
                </div>
                <div>
          ...
          {activeTab === 'ajuda' && (
            <div className="space-y-8 animate-in fade-in duration-300 max-w-4xl">
              {/* Header da Seção */}
              <div className="nm-flat p-6 border border-[#a855f7]/5 flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                ...
                <div className="flex items-center gap-2 text-[#a855f7] bg-[#a855f7]/5 px-3 py-1.5 border border-[#a855f7]/10 rounded-xl text-[8px] font-mono font-black uppercase tracking-widest">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 space-y-4">
                  ...
                  <div className="relative nm-inset aspect-video rounded-3xl overflow-hidden flex flex-col justify-between p-6 border border-[#2b303b]/40 bg-[#14161a] group">
                    ...
                    <div className="absolute inset-0 pointer-events-none overflow-hidden rounded-3xl z-0">
                      <div className="w-full h-1 bg-gradient-to-r from-transparent via-[#a855f7]/15 to-transparent absolute top-0 animate-bounce pointer-events-none" />
                    </div>

                    {/* Badge do Status do Vídeo */}
                    <div className="relative z-10 self-start px-2.5 py-1 bg-black/40 backdrop-blur-md border border-[#a855f7]/20 rounded-lg text-[8px] font-mono font-black uppercase tracking-widest text-[#a855f7] flex items-center gap-1.5 shadow-[0_0_10px_rgba(56,189,248,0.15)]">
                      <span className={`w-1.5 h-1.5 rounded-full ${isVideoPlaying ? 'bg-emerald-400 animate-ping' : 'bg-[#a855f7]'}`} />
                    ...
                    <div className="relative z-10 flex flex-col items-center justify-center flex-1 my-4 text-center">
                      {!isVideoPlaying ? (
                        <button
                          ...
                          className="w-16 h-16 rounded-full nm-button flex items-center justify-center text-[#a855f7] hover:text-[#eaeff5] hover:scale-110 active:scale-95 transition-all duration-300 group-hover:shadow-[0_0_20px_rgba(56,189,248,0.2)] border border-[#a855f7]/10"
                        >
                        ...
                        <button
                          ...
                          className="w-16 h-16 rounded-full nm-button flex items-center justify-center text-[#eaeff5] hover:text-[#a855f7] hover:scale-110 active:scale-95 transition-all duration-300 border border-white/5 opacity-0 group-hover:opacity-100"
                        >
                    ...
                    <div className="relative z-10 w-full flex items-center gap-3">
                      ...
                      >
                        <div
                          className="h-full bg-gradient-to-r from-[#a855f7] to-indigo-500 rounded-full transition-all duration-300 shadow-[0_0_8px_rgba(56,189,248,0.5)]"
                  ...
                  <div className="nm-flat px-6 py-4 flex items-center justify-between gap-6 border border-[#2b303b]/20">
                    <div className="flex items-center gap-3">
                      <button
                        ...
                        className="w-10 h-10 rounded-xl nm-button flex items-center justify-center text-[#eaeff5] hover:text-[#a855f7] transition-all"
                      >
                        {isVideoPlaying ? (
                ...
                <div className="space-y-3">
                  ...
                  {[
                    { title: "01. Conexão e Inicialização", duration: "12:45", desc: "Primeiros passos no Nexus 360", color: "border-[#a855f7]/10 text-[#a855f7]" },
                    ...
                    return (
                      <div
                        ...
                        className={`p-4 cursor-pointer border rounded-2xl transition-all duration-300 ${isSelected
                          ? "nm-inset border-[#a855f7]/25"
                          : "nm-flat border-[#2b303b]/20 hover:border-[#a855f7]/10 hover:scale-[1.01]"
                          }`}
                      >
                    ...
                    return (
                      ...
                      >
                        <button
                          ...
                          className="w-full flex items-center justify-between px-6 py-4.5 text-left font-mono hover:text-[#a855f7] transition-colors"
                        >
            ...
            <form onSubmit={handleNewTicket} className="space-y-5">
              ...
              <div className="flex gap-4 pt-3">
                ...
                <button type="submit" disabled={ticketLoading}
                  className="flex-1 py-3 nm-button text-[#eaeff5] hover:text-[#a855f7] text-[9px] font-mono font-black uppercase tracking-widest flex items-center justify-center gap-2 transition-all">
            ...
            <form onSubmit={handleUpdateProfile} className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full nm-inset py-3.5 px-4 text-xs outline-none text-[#eaeff5] placeholder:text-[#94a3b8]/30 transition-all focus:border-[#a855f7]/20"
                />
              </div>
